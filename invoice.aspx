...
<body>
    ...
    <tr><td style="margin: 10px; border-style: solid none none none; border-width: medium" 
        ...
        <asp:TextBox ID="txtdate" runat="server" Height="28px" Width="135px"></asp:TextBox>
    ...
    <tr><td align="justify" 
        ...
        <td>
            ...
            <td>
                <asp:TextBox ID="txtcname" runat="server" Height="29px" Width="206px"></asp:TextBox></td></tr>
            <tr style="font-family: 'Arial Rounded MT Bold'; font-size: 19px"><td align="right" 
                    class="style6">Job Card Number :</td>
            <td>
                <asp:TextBox ID="txtjob" runat="server" Height="29px" Width="206px"></asp:TextBox></td>
              <td align="right">Phone No. :</td>
              <td>
                  <asp:TextBox ID="txtmob" runat="server" Height="29px" Width="206px"></asp:TextBox></td>
                </tr>
        </table>
    </td></tr>
    <tr><td></td></tr>
    <tr><td align="center" style="font-family: 'Arial Black'; font-size: 29px" 
            class="style4">INVOICE  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
